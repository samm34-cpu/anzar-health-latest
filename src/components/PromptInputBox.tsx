...
import { ArrowUp, Paperclip, Square, X, StopCircle, Mic, Pill, MapPin } from "lucide-react";
...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  const { onSend = () => {}, isLoading = false, placeholder, className, lang = 'fr' } = props;
    ...
    <>
      ...
      >
        ...
        >
          <PromptInputTextarea
            ...
            className="text-sm bg-transparent font-serif px-1"
          />
        </div>
        ...
        <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
          ...
          >
            ...
            <div className="flex items-center">
              <button
                type="button"
                onClick={() => handleToggleChange("pharmacy")}
                className={cn(
                  "rounded-full transition-all flex items-center gap-1 px-2 py-1 border h-8",
                  showPharmacy
                    ? "bg-[#10B981]/15 border-[#10B981] text-[#10B981]"
                    : "bg-white border-gray-100 shadow-sm text-gray-400 hover:text-gray-600"
                )}
              >
                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                  ...
                  >
                    <Pill className={cn("w-4 h-4", showPharmacy ? "text-[#10B981]" : "text-inherit")} />
                  </motion.div>
                </div>
                <AnimatePresence>
                  {showPharmacy && (
          ...
          >
            <Button
              ...
              className={cn(
                ...
                isRecording
                  ...
                  : hasContent
                  ? consentChecked
                    ? "bg-[#4B5E7C] hover:bg-[#3A4A63] text-white"
            ...
            >
              {isLoading ? (
                ...
                <Mic className="h-5 w-5 text-gray-400 hover:text-gray-600 transition-colors" />
              )}
            </Button>
          </PromptInputAction>
        </PromptInputActions>
      ...
      <div className="mt-3 flex flex-col gap-2 px-2">
        <div className="flex items-center gap-2 overflow-hidden">
          ...
          />
          <label htmlFor="consent" className="text-[10px] sm:text-xs text-gray-500 cursor-pointer select-none leading-tight truncate">
            {lang === 'fr' 
